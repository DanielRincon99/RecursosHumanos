...
namespace RecursosHumanos.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,codigo,nombre")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,codigo,nombre")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
